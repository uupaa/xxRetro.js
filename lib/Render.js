...
function Render(resp) { // @arg ResourcePoolObject - { clock, atlas }
    ...
    this._pref          = this._resp["perf"];
    this._atlas         = this._resp["atlas"];
    this._canvasContext = this._resp["canvas"]["context"];
    this._canvasWidth   = this._resp["canvas"]["width"];
    this._canvasHeight  = this._resp["canvas"]["height"];
